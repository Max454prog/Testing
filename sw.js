...
// БАГФИКС: версия кеша поднята до v15 — после перехода иконок-кнопок с
// текстовых смайликов на inline-SVG у .icon-btn не было флекс-центрирования
// (display:inline-flex), из-за чего SVG внутри кнопок (крестики закрытия,
// плюс, шестерёнка и т.д.) висели не по центру — у инлайновых SVG есть
// известная особенность с "хвостиком" по базовой линии текста. Отдельно
// кнопка гамбургер-меню на телефоне переопределялась в мобильной
// медиа-запросе на `display:block`, которое перебивало центрирование ещё
// раз именно там, где эта кнопка реально видна. Также добавлено центрирование
// для крестика в чипах участников группы. Иначе часть пользователей ещё
// долго получала бы из кеша старую версию.
